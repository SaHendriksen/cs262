...
INSERT INTO Game VALUES (3, '2006-05-29 18:41:00', '2006-06-29 18:41:00');
...
INSERT INTO PlayerGame VALUES (2, 1, 2, 10.00, 0);
INSERT INTO PlayerGame VALUES (3, 1, 3, 2350.00, 0);
INSERT INTO PlayerGame VALUES (4, 2, 1, 10.00, 0);
INSERT INTO PlayerGame VALUES (5, 2, 2, 20.00, 0);
INSERT INTO PlayerGame VALUES (6, 2, 3, 30.00, 0);
INSERT INTO PlayerGame VALUES (7, 3, 2, 15.00, 0);
...
-- WHERE Game.startTime = '2006-06-28 13:20:00'
-- 	AND Player.ID = PlayerGame.playerID 
-- 	AND Game.ID = PlayerGame.gameID
-- ORDER BY PlayerGame.score DESC LIMIT 1;

-- c
-- If two players have the same name, it will return the player with the lower ID number. 
-- The P1 and P2 allow you to reference the Player table about two different records at the same time.

-- d
-- You may want to join a table to itself when you are trying to figure out a bill of materials.
-- You would want to in this scenario where the table has a part and a subpart and you want to figure out
-- all the parts that go into making a single part and list them out. This would require comparing parts to parts
-- and subsequently joining of the same parts table to itself.